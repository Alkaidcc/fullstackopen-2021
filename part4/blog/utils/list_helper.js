...
const mostBlogs = blogs => {
  ...
  const mostBlog = Object.entries(blogsByAuthors).reduce((prev, curr) => prev[1] > curr[1] ? prev : curr)
...
const mostLikes = blogs => {
  ...
  const mostLike = Object.entries(blogsByLikes).reduce((prev, curr) => prev[1] > curr[1] ? prev : curr)
